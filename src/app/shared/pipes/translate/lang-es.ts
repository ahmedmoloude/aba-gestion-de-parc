...
export const LANG_ES_TRANS = {
  ...
  'Liste des voyages': 'LISTA PDE VIAJES',
  'Liste des trajets': 'LISTA PDE RUTAS',
  'Gestion des utilisateurs': 'GESTION PDE USUARIOS',
  ...
  'Points de contrôle': 'PUNTO PDE CONTROL',
  ...
  Remorque: 'REMOLQUE',
  Choisir: 'ESCOGER',
  'Ville de Départ et Arrivée': 'CIUDAD PDE ORIGEN Y DESTINACIÓN',
  ...
  'Etat du voyage': 'ESTADO PDE VIAJE',
  'Etat du trajet': 'ESTADO PDE VIAJE',
  'Type de Voyage': 'TIPO PDE VIAJE',
  Client: 'CLIENTE',
  Nature: 'NATURALEZA',
  'Agrandir la carte': 'AMPLIAR MAPA',
  'SUIVI DU VOYAGE': 'SEGMUIMIENTO VIAJE',
  'Nombre de WPT': 'NUMMERO PDE PUNTOS GEOGRAFICOS',
  'DOCUMENTS WPT': 'DOCUMENTOS WPT',
  Type: 'TIPO',
  Chargement: 'CARGAS',
  Déchargement: 'DESCARGA',
  Passage: 'PASAJE',
  'Liste des utilisateurs': 'LISTA PDE USUARIOS',
  'Ajouter un utilisateur': 'AÑADIR USUARIO',
  'Recherche par matricule': 'BUSQUEDA POR NOMBRE',
  'Numéro User': 'NUMERO PDE USUARIO',
  Nom: 'NOMBRE',
  Prénom: 'APELLIDO',
  Login: 'USUARIO',
  Options: 'OPCIONES',
  ...
  'Nom client': 'NOMBRE PDE CLIENTE',

  Lier: 'ENLAZAR',
  'Recherche par nom client': 'BUSQUEDA POR NOMBRE PDE CLIENTE',
  ...
  'Recherche par nom conducteur': 'BUSQUEDA POR NOMBRE PDE CONDUCTOR',
  Supprimer: 'BORRAR',
  ...
  'Type de vehicule': 'TIPO PDE VEHÍCULO',
  'Point de contrôle': 'PUNTO PDE CONTROL',
  'Recherche par nom du point de contrôle':
    'BUSQUEDA POR NOMBRE PDE PUNTO PDE CONTROL',
  ...
  'Le Nom client est obligatoire': 'NOMBRE PDE CLIENTE OBLIGATORIO',
  Fermer: 'CERRAR',
  Close: 'CERRAR',
  ...
  'NOUVEAU POINT PDE CONTRÔLE': 'NUEVO PUNTO PDE CONTROL',
  'MIS A JOUR DU POINT PDE CONTRÔLE': 'MIS A JOUR DU POINT PDE CONTRÔLE',
  ...
  'Nom du point de contrôle': 'NOMBRE PDE PUNTO PDE CONTROL',
  'Le Nom du point de contrôle est obligatoire':
    'NOMBRE PDE PUNTO PDE CONTROL OBLIGATORIO',
  'Type de contrôle': 'TIPO PDE CONTROL',
  OK: 'OK',
  'Non OK': 'NOK',
  'Valeur(s)': 'VALOR (VALORES)',
  Valeur: 'VALOR',
  'Le type de contrôle est obligatoire': 'EL TIPO PDE CONTROL ES OBLIGATORIO',
  ...
  'Le matricule ne doit pas dépasser 16 caractères':
    'LA MATRICULA NO DEBE TENER MAS PDE 16 CARACTERES',
  successfully: 'EXITO',
  ERROR: 'ERROR',
  ...
  'ETAT DU WORKFLOW': 'ESTADO DEL FLUJO PDE TRABAJO',
  Valider: 'VALIDAR',
  Annuler: 'ANULAR',
  'Valider tous': 'VALIDAR TODO',
  'Liste des chargements': 'LISTA PDE CARGAS',
  'Liste des déchargements': 'LISTA PDE DESCARGAS',
  'Chargement pour le client': 'CLIENTE PDE CARGA',
  'Déchargement pour le client': 'CLIENTE PDE DESCARGA',
  Adresse: 'DIRECCIÓN',
  'Bougez le marker pour en déduire les coordonnées':
    'Mueve el marcador para deducir las coordenadas',
  Recherche: 'BUSQUEDA',
  'Points de contrôle pour': 'PUNTOS PDE CONTROL PARA',
  'Tous les points de contrôle': 'TODOS LOS PUNTOS PDE CONTROL',
  Next: 'SIGUIENTE',
  Previous: 'ANTERIOR',
  Loading: 'Cargando',
