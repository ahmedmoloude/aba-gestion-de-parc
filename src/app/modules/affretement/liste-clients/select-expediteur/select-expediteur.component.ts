...
@Component({
  selector: 'app-select-expediteur',
  templateUrl: './select-expediteur.component.html',
  styleUrls: ['./select-expediteur.component.css']
})
export class SelectExpediteurComponent implements OnInit {
