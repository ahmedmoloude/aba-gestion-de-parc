...
@Component({
  selector: 'app-dialog-bordereau-versement',
  templateUrl: './dialog-bordereau-versement.component.html',
  styleUrls: ['./dialog-bordereau-versement.component.css']
})
export class DialogBordereauVersementComponent implements OnInit {
  image_src: string;
