...
@Component({
  selector: 'app-affretment-condition',
  templateUrl: './affretment-condition.component.html',
  styleUrls: ['./affretment-condition.component.css']
})
export class AffretmentConditionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.store.select(selectConditionsMetaIdsAffretment).subscribe((res) => {
      ...
      console.log('conditions meta ids ' ,  res)
