...
@Component({
  selector: 'app-affretment-convention',
  templateUrl: './affretment-convention.component.html',
  styleUrls: ['./affretment-convention.component.css']
})
export class AffretmentConventionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('inputs ... ..'   , this.grid , this.position , this.rubric_type )
  }
  openConditionDialog(editMode: boolean): void {
    this.dialog.open(AffretmentConditionDialogComponent, {
      disableClose: true,
      width: '1000px',
      data: {
